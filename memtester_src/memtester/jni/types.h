...
#ifndef	__MEMTESTER_TYPES_H__
#define	__MEMTESTER_TYPES_H__
...
struct test {
	char *name;
	int (*fp_half)(ulv *bufa, ulv *bufb, size_t count);
	int (*fp_all)(ulv *bufa, size_t count);
};
